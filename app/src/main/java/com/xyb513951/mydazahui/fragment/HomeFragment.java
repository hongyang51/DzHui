...
import com.xyb513951.mydazahui.adapter.HomeFragment_List_Adapter;
import com.xyb513951.mydazahui.adapter.HomeFragment_ViewPager_Adapter;
...
import com.xyb513951.mydazahui.greendaobean.LatestNews;
...
import com.xyb513951.mydazahui.utils.refresh.SwipeRefreshLoadingLayout;
...
public class HomeFragment extends BaseFragment implements SwipeRefreshLoadingLayout.OnLoadListener, SwipeRefreshLoadingLayout.OnRefreshListener {
    ...
    private void initTheme() {
        for (int i = 0; i < img_id.length; i++) {
            if (othersEntities != null && othersEntities.size()>0) {
