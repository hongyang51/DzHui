...
import com.xyb513951.mydazahui.greendaobean.GuidePage;
import com.xyb513951.mydazahui.greendaobean.GuidePageDao;
import com.xyb513951.mydazahui.utils.daosingleton.DaoSingleton;
import com.xyb513951.mydazahui.utils.sharedprefer.SharedPreferUtil;
...
public class PWReadOneActivity extends MainActivity {
    ...
    private void initDatas() {
        ...
        if (guidePageDao.loadAll().size() > 0) {
            ArrayList<com.xyb513951.mydazahui.greendaobean.GuidePage> page = (ArrayList<com.xyb513951.mydazahui.greendaobean.GuidePage>) guidePageDao.loadAll();
            com.xyb513951.mydazahui.greendaobean.GuidePage guidePage = page.get(0);
